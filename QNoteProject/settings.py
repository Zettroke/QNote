"""
Django settings for QNoteProject project.
...
MIDDLEWARE = [
    ...
    'main.middleware.auto_timezone.UserTimezoneAutoSetupMiddleware',
]

ROOT_URLCONF = 'QNoteProject.urls'
...
WSGI_APPLICATION = 'QNoteProject.wsgi.application'
